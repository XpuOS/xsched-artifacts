...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimascend.so ${TESTCASE_ROOT}/output/bin/fp_fg \
...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimascend.so ${TESTCASE_ROOT}/output/bin/fp_bg \
    ${ROOT}/assets/models/ascend &
BG_PID=$!
echo "BG_PID: ${BG_PID}"
