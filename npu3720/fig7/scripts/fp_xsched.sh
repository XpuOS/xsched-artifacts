...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimlevelzero.so ${TESTCASE_ROOT}/output/bin/fp_fg \
...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimlevelzero.so ${TESTCASE_ROOT}/output/bin/fp_bg \
    ${ROOT}/assets/models/resnet152.xml &
BG_PID=$!
echo "BG_PID: ${BG_PID}"
