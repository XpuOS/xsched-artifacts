...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimlevelzero.so ${TESTCASE_ROOT}/output/bin/up_fg \
...
LD_PRELOAD=${TESTCASE_ROOT}/output/lib/libshimlevelzero.so ${TESTCASE_ROOT}/output/bin/up_bg \
    ${ROOT}/assets/models/resnet152.xml \
    ${RESULT_DIR}/up_xsched_${dev_name}.thpt &
BG_PID=$!
echo "BG_PID: ${BG_PID}"
