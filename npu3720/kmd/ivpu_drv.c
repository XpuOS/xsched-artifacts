...
int ivpu_sched_mode = VPU_SCHEDULING_MODE_HW;
int ivpu_sched_mode_fake;
module_param_named(sched_mode, ivpu_sched_mode_fake, int, 0444);
...
static const struct drm_ioctl_desc ivpu_drm_ioctls[] = {
	...
	DRM_IOCTL_DEF_DRV(IVPU_SCHEDULE, ivpu_schedule_ioctl, 0),
};
...
static int ivpu_dev_init(struct ivpu_device *vdev)
{
	...
	ivpu_info(vdev, "vpu driver with scheduling support initialized\n");
