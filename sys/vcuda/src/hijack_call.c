...
/** hijack entrypoint */
CUresult cuDriverGetVersion(int *driverVersion) {
  LOGGER(5, "intercepted cuDriverGetVersion");
  CUresult ret;
...
DONE:
  LOGGER(5, "intercepted cuDriverGetVersion, ret: %d", ret);
  return ret;
}

CUresult cuInit(unsigned int flag) {
  LOGGER(5, "intercepted cuInit");
  CUresult ret;
...
DONE:
  LOGGER(5, "intercepted cuInit, ret: %d", ret);  
  return ret;
}

CUresult cuGetProcAddress(const char *symbol, void **pfn, int cudaVersion,
                          cuuint64_t flags) {
  LOGGER(5, "intercepted cuGetProcAddress");
  CUresult ret;
  int i;
  ...
  LOGGER(5, "intercepted cuGetProcAddress, ret: %d", ret);
  return ret;
}

CUresult cuMemAllocManaged(CUdeviceptr *dptr, size_t bytesize,
                           unsigned int flags) {
  LOGGER(5, "intercepted cuMemAllocManaged");
  size_t used = 0;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuMemAllocManaged, dptr, bytesize,
                        flags);
DONE:
  LOGGER(5, "intercepted cuMemAllocManaged, ret: %d", ret);
  return ret;
}

CUresult cuMemAlloc_v2(CUdeviceptr *dptr, size_t bytesize) {
  LOGGER(5, "intercepted cuMemAlloc_v2");
  size_t used = 0;
  size_t request_size = bytesize;
  CUresult ret;
...
DONE:
  LOGGER(5, "intercepted cuMemAlloc_v2, ret: %d", ret);
  return ret;
}

CUresult cuMemAlloc(CUdeviceptr *dptr, size_t bytesize) {
  LOGGER(5, "intercepted cuMemAlloc");
  size_t used = 0;
  size_t request_size = bytesize;
  CUresult ret;
  ...
  if (g_vcuda_config.enable) {
    ...
    LOGGER(5, "used: %zu, request_size: %zu, gpu_memory: %zu", used, request_size, g_vcuda_config.gpu_memory);
    if (unlikely(used + request_size > g_vcuda_config.gpu_memory)) {
      ret = CUDA_ERROR_OUT_OF_MEMORY;
      goto DONE;
    }
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuMemAlloc_v2, dptr, bytesize);
DONE:
  LOGGER(5, "intercepted cuMemAlloc, ret: %d", ret);
  return ret;
}
...
CUresult cuMemAllocPitch_v2(CUdeviceptr *dptr, size_t *pPitch,
                            size_t WidthInBytes, size_t Height,
                            unsigned int ElementSizeBytes) {
  LOGGER(5, "intercepted cuMemAllocPitch_v2");
  size_t used = 0;
...
DONE:
  LOGGER(5, "intercepted cuMemAllocPitch_v2, ret: %d", ret);
  return ret;
}

CUresult cuMemAllocPitch(CUdeviceptr *dptr, size_t *pPitch, size_t WidthInBytes,
                         size_t Height, unsigned int ElementSizeBytes) {
  LOGGER(5, "intercepted cuMemAllocPitch");
  size_t used = 0;
  size_t request_size = ROUND_UP(WidthInBytes * Height, ElementSizeBytes);
  CUresult ret;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuMemAllocPitch, dptr, pPitch,
                        WidthInBytes, Height, ElementSizeBytes);
DONE:
  LOGGER(5, "intercepted cuMemAllocPitch, ret: %d", ret);
  return ret;
}
...
cuArrayCreate_helper(const CUDA_ARRAY_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArrayCreate_helper");  
  size_t used = 0;
  size_t base_size = 0;
...
DONE:
  LOGGER(5, "intercepted cuArrayCreate_helper, ret: %d", ret);
  return ret;
}

CUresult cuArrayCreate_v2(CUarray *pHandle,
                          const CUDA_ARRAY_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArrayCreate_v2");
  CUresult ret;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuArrayCreate_v2, pHandle,
                        pAllocateArray);
DONE:
  LOGGER(5, "intercepted cuArrayCreate_v2, ret: %d", ret);
  return ret;
}

CUresult cuArrayCreate(CUarray *pHandle,
                       const CUDA_ARRAY_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArrayCreate");
  CUresult ret;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuArrayCreate, pHandle,
                        pAllocateArray);
DONE:
  LOGGER(5, "intercepted cuArrayCreate, ret: %d", ret);
  return ret;
}

static CUresult
cuArray3DCreate_helper(const CUDA_ARRAY3D_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArray3DCreate_helper");
  size_t used = 0;
  size_t base_size = 0;
  size_t request_size = 0;
  CUresult ret = CUDA_SUCCESS;
...
DONE:
  LOGGER(5, "intercepted cuArray3DCreate_helper, ret: %d", ret);
  return ret;
}

CUresult cuArray3DCreate_v2(CUarray *pHandle,
                            const CUDA_ARRAY3D_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArray3DCreate_v2");
  CUresult ret;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuArray3DCreate_v2, pHandle,
                        pAllocateArray);
DONE:
  LOGGER(5, "intercepted cuArray3DCreate_v2, ret: %d", ret);
  return ret;
}

CUresult cuArray3DCreate(CUarray *pHandle,
                         const CUDA_ARRAY3D_DESCRIPTOR *pAllocateArray) {
  LOGGER(5, "intercepted cuArray3DCreate");
  CUresult ret;
  ...
  ret = CUDA_ENTRY_CALL(cuda_library_entry, cuArray3DCreate, pHandle,
                        pAllocateArray);
DONE:
  LOGGER(5, "intercepted cuArray3DCreate, ret: %d", ret);
  return ret;
}
...
cuMipmappedArrayCreate(CUmipmappedArray *pHandle,
                       const CUDA_ARRAY3D_DESCRIPTOR *pMipmappedArrayDesc,
                       unsigned int numMipmapLevels) {
  LOGGER(5, "intercepted cuMipmappedArrayCreate");
  size_t used = 0;
  size_t base_size = 0;
  size_t request_size = 0;
  CUresult ret;
...
DONE:
  LOGGER(5, "intercepted cuMipmappedArrayCreate, ret: %d", ret);
  return ret;
}

CUresult cuDeviceTotalMem_v2(size_t *bytes, CUdevice dev) {
  LOGGER(5, "intercepted cuDeviceTotalMem_v2");
  if (g_vcuda_config.enable) {
...
CUresult cuDeviceTotalMem(size_t *bytes, CUdevice dev) {
  LOGGER(5, "intercepted cuDeviceTotalMem");
  if (g_vcuda_config.enable) {
    *bytes = g_vcuda_config.gpu_memory;
...
CUresult cuMemGetInfo_v2(size_t *free, size_t *total) {
  LOGGER(5, "intercepted cuMemGetInfo_v2");
  size_t used = 0;
...
CUresult cuMemGetInfo(size_t *free, size_t *total) {
  LOGGER(5, "intercepted cuMemGetInfo");
  size_t used = 0;
...
CUresult cuLaunchKernel_ptsz(CUfunction f, unsigned int gridDimX,
                             ...
                             unsigned int sharedMemBytes, CUstream hStream,
                             void **kernelParams, void **extra) {
  LOGGER(5, "intercepted cuLaunchKernel_ptsz");
...
CUresult cuLaunchKernel(CUfunction f, unsigned int gridDimX,
                        ...
                        unsigned int blockDimZ, unsigned int sharedMemBytes,
                        CUstream hStream, void **kernelParams, void **extra) {
  LOGGER(5, "intercepted cuLaunchKernel");
  rate_limiter(gridDimX * gridDimY * gridDimZ,
               blockDimX * blockDimY * blockDimZ);
...
CUresult cuLaunchCooperativeKernel_ptsz(
    ...
    unsigned int blockDimZ, unsigned int sharedMemBytes, CUstream hStream,
    void **kernelParams) {
  LOGGER(5, "intercepted cuLaunchCooperativeKernel_ptsz");
  rate_limiter(gridDimX * gridDimY * gridDimZ,
               blockDimX * blockDimY * blockDimZ);
...
CUresult cuLaunchCooperativeKernel(CUfunction f, unsigned int gridDimX,
                                   ...
                                   unsigned int sharedMemBytes,
                                   CUstream hStream, void **kernelParams) {
  LOGGER(5, "intercepted cuLaunchCooperativeKernel");
  rate_limiter(gridDimX * gridDimY * gridDimZ,
               blockDimX * blockDimY * blockDimZ);
...
CUresult cuLaunchGrid(CUfunction f, int grid_width, int grid_height) {
  LOGGER(5, "intercepted cuLaunchGrid");
...
CUresult cuLaunchGridAsync(CUfunction f, int grid_width, int grid_height,
                           CUstream hStream) {
  LOGGER(5, "intercepted cuLaunchGridAsync");
  rate_limiter(grid_width * grid_height, g_block_x * g_block_y * g_block_z);
...
CUresult cuFuncSetBlockShape(CUfunction hfunc, int x, int y, int z) {
  LOGGER(5, "intercepted cuFuncSetBlockShape");
  if (g_vcuda_config.enable) {
