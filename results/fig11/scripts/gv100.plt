...
set origin 0,0
set size 0.65,0.35
set title "NVIDIA GV100" font ",20" offset 0,-0.8
...
plot gv100_dat using (($3)/$2):xticlabels(1) t "Native"   w histogram lw 2 lc rgb Base_COLOR, \
     gv100_dat using (($4)/$2):xticlabels(1) t "vCUDA"    w histogram lw 2 lc rgb vCUDA_COLOR, \
     gv100_dat using (($5)/$2):xticlabels(1) t "TGS"    w histogram lw 2 lc rgb TGS_COLOR, \
     gv100_dat using (($6)/$2):xticlabels(1) t SYSTEM_NAME    w histogram lw 2 lc rgb XSched_COLOR
